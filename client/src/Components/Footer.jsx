...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white pt-[65px] ">
      <Containar>
        <div className="flex md:flex-row flex-col justify-between">
          <div className="md:w-[22%] w-full">
            ...
            <p className="text-[#F1F5F9] text-[14px] mb-4 mt-4">
              Experience our new platform & Enjoy great deals and offers on your
              day to day
            </p>
            <div>
              <div className="flex gap-x-2 items-center">
                ...
                <p className="text-[#F1F5F9] text-sm">
                  House #64, Road13, ASA Center, Uttera, Dhaka-1402
                </p>
              </div>
            </div>
            <div className="mt-4">
              <div className="flex items-center gap-x-2">
                ...
                <p className="text-[#F1F5F9] text-sm">01729-1497201</p>
              </div>
            </div>
            <div className="mt-4">
              <div className="flex items-center gap-x-2">
                ...
                <p className="text-[#F1F5F9] text-sm">falcon@gmail.com</p>
              </div>
            </div>
          </div>

          <div>
            <h3 className="text-[18px] font-medium uppercase tracking-wider text-[#94A3B8] mb-3 md:mt-0 mt-5">
              ABOUT
            </h3>
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="text-[white] text-base font-medium hover:text-white"
                >
                  Contact Us
                </a>
              </li>
          ...
          <div>
            <h3 className="text-[18px] font-medium uppercase tracking-wider text-[#94A3B8] md:mt-0 mt-5 mb-3">
              HELP
            </h3>
            <ul className="space-y-2">
              <li>
                <a
                  href="#"
                  className="text-[#F1F5F9] text-base font-medium hover:text-white"
                >
                  Payments
                </a>
              </li>
        ...
        <div className="flex md:flex-row flex-col  items-center justify-between mt-[32px]">
          ...
          <div className="flex md:flex-row flex-col md:mt-0 mt-5 items-center">
            <h3 className="text-[18px] font-medium  uppercase tracking-wider text-[#94A3B8] ">
              PAYMENTS ACCEPTED
            </h3>
      ...
      <p className="text-sm pt-[30px] pb-[23px] font-normal text-center text-white mt-[37px] border border-[rgba(217,217,217,19%)]">
